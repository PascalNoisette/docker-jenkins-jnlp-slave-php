...
RUN apt-get install -y python-crypto python-httplib2 python-jinja2 python-paramiko python-pkg-resources python-yaml python-pip && pip install ansible==2.4.2.0
